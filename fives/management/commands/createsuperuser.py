...
# Overridden to add player object at point superuser is created.
...
from fives.models import User, Player
    ...
    def handle(self, *args, **options):
        ...
        if username:
            ...
            if options['verbosity'] >= 1:
                ...
                self.stdout.write("A basic player profile has been added. If you wish to edit the details, please visit the admin page.")
